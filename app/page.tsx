  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h2 className="text-4xl md:text-6xl font-bold mb-6 text-balance leading-tight">
            Learn to Spot Scams <span className="text-primary">Before They Happen</span>
          </h2>
          <p className="text-lg md:text-xl text-muted-foreground mb-8 max-w-2xl mx-auto text-pretty leading-relaxed">
            Experience real scam scenarios in a safe environment. Understand how scammers manipulate people and learn to
            recognize red flags through interactive games.
          </p>
      ...
      <section id="how-it-works" className="bg-muted/30 py-16">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            <h3 className="text-3xl md:text-4xl font-bold mb-4 text-balance">How It Works</h3>
            <p className="text-muted-foreground text-pretty leading-relaxed">
              Three engaging modules designed to teach you scam detection through interactive experiences
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            <Card className="p-6 text-center border-2 hover:border-primary transition-colors">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Pick from Story Adventure, Flash-Card Challenge, or Red Flag Hunter
              </p>
            </Card>
            <Card className="p-6 text-center border-2 hover:border-primary transition-colors">
              <div className="w-12 h-12 rounded-lg bg-primary/10 flex items-center justify-center mx-auto mb-4">
            ...
            <Card className="p-6 text-center border-2 hover:border-primary transition-colors">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed">
                Get instant feedback, understand red flags, and build your skills
              </p>
            </Card>
          </div>
        </div>
      ...
      <section id="modules" className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center mb-12">
          <h3 className="text-3xl md:text-4xl font-bold mb-4 text-balance">Choose Your Learning Path</h3>
          <p className="text-muted-foreground text-pretty leading-relaxed">
            Each module offers a unique way to understand scam techniques and build your detection skills
          </p>
        </div>
        <div className="grid md:grid-cols-3 gap-6 max-w-6xl mx-auto">
          ...
          <Card className="overflow-hidden group hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                Navigate branching scenarios where every path reveals different scam techniques. No matter your choice,
                you'll learn.
              </p>
          ...
          <Card className="overflow-hidden group hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                Race against time to identify scams vs safe messages. Build speed and accuracy with instant feedback.
              </p>
          ...
          <Card className="overflow-hidden group hover:shadow-lg transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-sm text-muted-foreground mb-4 leading-relaxed">
                Read scenarios and identify red flags on your board. Train your pattern recognition skills across
                multiple scenarios.
              </p>
      ...
      <footer className="border-t border-border bg-card/50 py-8">
        <div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
          ...
          <p className="mt-2">Learn to protect yourself and others from online scams</p>
        </div>
      </footer>
    </div>
  )
